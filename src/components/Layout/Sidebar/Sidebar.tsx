...
export function Sidebar () {
  ...
  return (
    <aside className={`h-full relative rounded-md  opacity-0 ease-in-out  bg-zinc-100 w-0 items-start overflow-hidden p-2 transition-all duration-200 border-r border-t  border-zinc-300 dark:bg-zinc-950 dark:border-zinc-800 ${isOpen ? ` min-w-36 opacity-100 ` : `w-16 -mx-8`}`}>
