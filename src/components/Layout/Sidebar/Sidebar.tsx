...
export function Sidebar () {
  ...
  return (
    <aside className={` rounded-md  opacity-0 ease-in-out  h-screen  bg-zinc-100 w-0 items-start overflow-hidden p-2 transition-all duration-200 border-r border-t  border-zinc-300 dark:bg-zinc-950 dark:border-zinc-800 ${isOpen ? ` min-w-36 opacity-100 ` : `w-0 -mx-2`}`}>
