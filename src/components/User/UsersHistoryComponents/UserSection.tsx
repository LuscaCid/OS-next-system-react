...
export function UsersSection () {
  ...
  return (
    <section className="w-4/5 relative border-b border-r border-zinc-300 dark:border-zinc-800/80">
      <h1 className=" p-2 flex items-center gap-2 text-2xl font-bold border border-t-0 border-l-0 border-r-0sA  border-zinc-300 dark:border-zinc-800 w-full">
